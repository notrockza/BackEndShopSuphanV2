...
namespace ShopSuphan.Services
{
    public class AccountService : IAccountService
    {
        ...
        //private async Task AddPassword(int accountID, string accountPassword)
        //{
        //    var data = new AccountPassword() { ID = await GenerateIDPassword(), AccountID = accountID, Password = accountPassword };
        //    await databaseContext.AccountPassword.AddAsync(data);
        //}
        ...
        public async Task<string> GenerateIDPassword()
        {
            ...
            while (true)
            {
                ...
                var result = await databaseContext.AccountPassword.FindAsync(Id);
